		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comarchivelabelszesparchivelabels-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comarchivelabelszesparchivelabels-display": {
								"semanticObject": "comarchivelabelszesparchivelabels",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.archivelabels.zesparchivelabels",
									"url": sap.ui.require.toUrl("com/archivelabels/zesparchivelabels")
								}
							}
						}
					}
